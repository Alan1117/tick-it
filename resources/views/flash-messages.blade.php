...
@if(session('info'))
    <div x-data="{ show: true }" x-show="show" class="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded relative" role="alert">
...
@if(session('warning'))
    <div x-data="{ show: true }" x-show="show" class="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded relative" role="alert">
